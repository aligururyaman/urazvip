...
export default function HakkimizdaPage() {
  ...
  return (
    <>
      <Head>
        <title>Hakkımızda | URAZ VİP TRANSFER</title>
        <meta name="description" content="URAZ VİP TRANSFER olarak Antalya Havalimanı'ndan şehrin tüm noktalarına güvenilir ve konforlu VIP transfer hizmeti sunuyoruz." />
        <meta name="keywords" content="Hakkımızda, URAZ VIP, Antalya transfer, güvenilir transfer, lüks araç, profesyonel şoför" />
        <meta property="og:title" content="Hakkımızda | URAZ VİP TRANSFER" />
        <meta property="og:description" content="URAZ VİP TRANSFER olarak Antalya Havalimanı'ndan şehrin tüm noktalarına güvenilir ve konforlu VIP transfer hizmeti sunuyoruz." />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://urazvip.com/hakkimizda" />
